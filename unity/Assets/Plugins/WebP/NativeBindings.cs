...
namespace WebP.Extern
{
    ...
    public class NativeBindings
    {
		...
		/// Return Type: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPGetDecoderVersion")]
		public static extern int WebPGetDecoderVersion();

		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPSafeFree")]
		...
		/// <returns></returns>
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPGetInfo")]
		...
		///width: int*
		///height: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeRGBA")]
		...
		///width: int*
		///height: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeARGB")]
		...
		///width: int*
		///height: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeBGRA")]
		...
		///width: int*
		///height: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeRGB")]
		...
		///width: int*
		///height: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeBGR")]
		...
		///stride: int*
		///uv_stride: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeYUV")]
		...
		///output_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeRGBAInto")]
		...
		///output_buffer_size: size_t->unsigned int
		///output_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeARGBInto")]
		...
		///output_buffer_size: size_t->unsigned int
		///output_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeBGRAInto")]
		...
		///output_buffer_size: size_t->unsigned int
		///output_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeRGBInto")]
		...
		///output_buffer_size: size_t->unsigned int
		///output_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeBGRInto")]
		...
		///v_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPDecodeYUVInto")]
		...
		///output_buffer_size: size_t->unsigned int
		///output_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPINewRGB")]
		...
		///a_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPINewYUVA")]
		...
		///v_size: size_t->unsigned int
		///v_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPINewYUV")]
		...
		/// Return Type: void
		///idec: WebPIDecoder*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPIDelete")]
		...
		///data: uint8_t*
		///data_size: size_t->unsigned int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPIAppend")]
		...
		///data: uint8_t*
		///data_size: size_t->unsigned int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPIUpdate")]
		...
		///height: int*
		///stride: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPIDecGetRGB")]
		...
		///uv_stride: int*
		///a_stride: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPIDecGetYUVA")]
		...
		///width: int*
		///height: int*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPIDecodedArea")]
		...
		///param3: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPGetFeaturesInternal")]
		...
		///param1: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPInitDecoderConfigInternal")]
		...
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPIDecode")]
		...
		///output: uint8_t**
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncodeRGB")]
		...
		///quality_factor: float
		///output: uint8_t**
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncodeBGR")]
		...
		///quality_factor: float
		///output: uint8_t**
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncodeRGBA")]
		...
		///quality_factor: float
		///output: uint8_t**
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncodeBGRA")]
		...
		///stride: int
		///output: uint8_t**
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncodeLosslessRGB")]
		...
		///stride: int
		///output: uint8_t**
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncodeLosslessBGR")]
		...
		///stride: int
		///output: uint8_t**
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncodeLosslessRGBA")]
		...
		///stride: int
		///output: uint8_t**
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncodeLosslessBGRA")]
		...
		///data_size: size_t->unsigned int
		///picture: WebPPicture*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPMemoryWrite")]
		...
		///param0: WebPPicture*
		///param1: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureInitInternal")]
		public static extern int WebPPictureInitInternal(ref WebPPicture param0, int param1);


		/// Return Type: int
		///picture: WebPPicture*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureAlloc")]
		public static extern int WebPPictureAlloc(ref WebPPicture picture);


		/// Return Type: void
		///picture: WebPPicture*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureFree")]
		...
		///src: WebPPicture*
		///dst: WebPPicture*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureCopy")]
		...
		/// <returns></returns>
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureDistortion")]
		...
		///width: int
		///height: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureCrop")]
		...
		///width: int
		///height: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureRescale")]
		...
		///rgb: uint8_t*
		///rgb_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureImportRGB")]
		...
		///rgba: uint8_t*
		///rgba_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureImportRGBA")]
		...
		///rgbx: uint8_t*
		///rgbx_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureImportRGBX")]
		...
		///bgr: uint8_t*
		///bgr_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureImportBGR")]
		...
		///bgra: uint8_t*
		///bgra_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureImportBGRA")]
		...
		///bgrx: uint8_t*
		///bgrx_stride: int
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureImportBGRX")]
		...
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureARGBToYUVA")]
		public static extern int WebPPictureARGBToYUVA(ref WebPPicture picture, WebPEncCSP colorspace);


		/// Return Type: int
		///picture: WebPPicture*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureYUVAToARGB")]
		public static extern int WebPPictureYUVAToARGB(ref WebPPicture picture);


		/// Return Type: void
		///picture: WebPPicture*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPCleanupTransparentArea")]
		public static extern void WebPCleanupTransparentArea(ref WebPPicture picture);


		/// Return Type: int
		///picture: WebPPicture*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPPictureHasTransparency")]
		...
		///config: WebPConfig*
		///picture: WebPPicture*
		[DllImportAttribute(WEBP_LIB, EntryPoint = "WebPEncode")]
